...
import io.security.springsecuritymaster.admin.repositiory.RoleRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void createUserIfNotFound(final String userName, final String email, final String password, Set<Role> roleSet) {
